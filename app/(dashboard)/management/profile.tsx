    ...
    useEffect(() => {
        const loadProfile = async () => {
            try {
                ...
                const cacheTimestamp = await AsyncStorage.getItem('management_profile_timestamp');
    ...
    const fetchProfileData = async () => {
        try {
            ...
            if (response.data) {
                ...
                await Promise.all([
                    AsyncStorage.setItem('management_profile', JSON.stringify(profileData)),
                    AsyncStorage.setItem('management_profile_timestamp', Date.now().toString())
                ]);
            }
        } catch (error) {
