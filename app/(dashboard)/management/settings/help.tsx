...
const articleSteps: Record<string, Step[]> = {
  '1-1': [
    ...
    },
    {
      id: '2',
      title: 'Login',
      description: 'Open the Parrot Analyzer app, enter your credentials, and click Login.',
      icon: 'login',
    },
    {
      id: '3',
      title: 'Update Profile',
      description: 'Navigate to the Profile section and update your personal details (e.g., name, contact information).',
      icon: 'person',
    },
    {
      id: '4',
      title: 'Change Password',
      description: 'Go to Settings > Security, click Change Password, and set a new secure password.',
      icon: 'lock',
    },
    {
      id: '5',
      title: 'Explore Features',
      description: 'Access available tools like Team Management, Notifications, and Report Settings to start managing your activities.',
      icon: 'explore',
    },
  ],
  '1-2': [
    ...
    },
    {
      id: '2',
      title: 'Navigation',
      description: 'Access features via the menu (e.g., Team Management, Notifications).',
      icon: 'menu',
    },
    {
      id: '3',
      title: 'Real-Time Data',
      description: 'View live updates like employee locations and shift statuses.',
      icon: 'update',
    },
    {
      id: '4',
    ...
    },
    {
      id: '5',
      title: 'Alerts',
      description: 'Address highlighted tasks like approvals or unread notifications.',
      icon: 'notifications',
    },
  ],
  '2-1': [
    {
      id: '1',
      title: 'View Team',
      description: 'Navigate to Team Management to see a list of all team members.',
      icon: 'group',
    },
    {
      id: '2',
      title: 'Add Members',
      description: 'Use the Add Member button to input details manually or upload a CSV file for bulk additions.',
      icon: 'person-add',
    },
    {
      id: '3',
      title: 'Edit Details',
      description: 'Select a team member and click Edit to update their role or contact information.',
      icon: 'edit',
    },
    {
      id: '4',
    ...
    },
    {
      ...
      description: 'Quickly find team members using the search bar or role/status filters.',
      icon: 'filter-list',
    },
  ],
  '2-2': [
    ...
    },
    {
      ...
      description: 'Enable or disable options for sharing data with other team members or departments.',
      icon: 'share',
    },
    {
      id: '3',
      title: 'Manage Permissions',
      description: 'Set who can view or edit your reports, location, or personal details.',
      icon: 'security',
    },
    {
      id: '4',
      title: 'Password Protection',
      description: 'Ensure your account is secure by regularly updating your password in the Security section.',
      icon: 'lock',
    },
    {
      id: '5',
      title: 'Activity Logs',
      description: 'Review your recent activities and changes to ensure account security.',
      icon: 'history',
    },
  ],
  '3-1': [
    ...
    },
    {
      ...
      description: 'Choose the desired report category (e.g., expenses, attendance).',
      icon: 'category',
    },
    {
      id: '3',
    ...
    },
    {
      ...
      description: 'Review the report summary to ensure accuracy before generating.',
      icon: 'preview',
    },
    {
      id: '5',
      title: 'Download or Share',
      description: 'Export the report in your preferred format (e.g., PDF, Excel) or share it directly via email.',
      icon: 'download',
    },
  ],
  '3-2': [
    {
      ...
      description: 'View key performance indicators (KPIs) like attendance trends, expense summaries, or task completion rates.',
      icon: 'speed',
    },
    {
      id: '2',
      title: 'Charts and Graphs',
      description: 'Analyze visual representations of data for insights into patterns and trends.',
      icon: 'insert-chart',
    },
    {
      id: '3',
      title: 'Filters',
      description: 'Apply filters like date range, department, or team to refine analytics.',
      icon: 'filter-list',
    },
    {
      id: '4',
      title: 'Drill-Down Data',
      description: 'Click on specific metrics or chart sections for detailed information.',
      icon: 'zoom-in',
    },
    {
      id: '5',
