                ...
                <View className="p-6">
                    ...
                    {isLoading ? (
                        ...
                        <View className="flex-row flex-wrap justify-between">
                            {[
                                { label: 'Avg Performance', ...analyticsData.keyMetrics.avgPerformance },
                                { label: 'Attendance Rate', ...analyticsData.keyMetrics.attendanceRate },
                                { label: 'Task Completion', ...analyticsData.keyMetrics.taskCompletion },
                                { label: 'Team Efficiency', ...analyticsData.keyMetrics.teamEfficiency },
                            ].map((metric, index) => (
                                <View
                                    key={index}
