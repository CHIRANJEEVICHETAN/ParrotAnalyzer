        ...
        <View style={styles.container}>
            ...
            >
                <View className="flex-row items-center justify-between px-6">
                    ...
                    >
                        <Ionicons name="list-outline" size={24} color={theme === 'dark' ? '#FFFFFF' : '#000000'} />
                    </TouchableOpacity>
                </View>
            </LinearGradient>
            ...
            >
                ...
                <View className="px-6 py-4">
                    ...
                    >
                        <Text className={`text-lg font-semibold mb-2 ${theme === 'dark' ? 'text-white' : 'text-gray-900'}`}>
                            Security Score
                        </Text>
                                                ...
                                                <View className="flex-row items-center">
                                                    ...
                                                    {item.criticalSetting && (
                                                        <View className="ml-2 px-2 py-1 bg-red-500 rounded-full">
                                                            <Text className="text-white text-xs">Critical</Text>
                                                        </View>
                                                    )}
                                                </View>
                                                <Text 
                    ...
                    >
                        {securityEvents.map((event, index) => (
                            <View 
                                key={index}
                                className={`p-4 ${
                                    index !== securityEvents.length - 1 ? 'border-b border-gray-700' : ''
                                }`}
                            >
