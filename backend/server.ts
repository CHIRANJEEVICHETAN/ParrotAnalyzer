...
import shiftTimerRoutes from "./src/routes/employeeRoutes";
...
import leaveApprovalsRoutes from "./src/routes/leave-approvals";
...
app.use("/api/shift-timer", shiftTimerRoutes);
app.use("/api/group-admins", groupAdminsRoutes);
app.use("/api/tasks", tasksRoutes);
app.use("/api/notifications", notificationsRouter);
app.use("/api/leave", leaveRoutes);
app.use("/api/leave-approvals", leaveApprovalsRoutes);
